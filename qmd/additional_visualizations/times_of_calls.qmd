...
## To do: Anrufende, die nach mehreren Versuchen durchkommen als "successful" markieren? Legende übersetzen

_feedback_: could we plot the share instead of the total numbers? Right now, the visual impression is that the **share** of successful calls is the same but this is not true because for some days there are more calls 
...
- legend position bottom (ggplot theme) might be a good idea to give the plots more horizontal space
